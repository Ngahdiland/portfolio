    ...
    <div className="flex flex-col sm:flex-row mt-[40px]">
      <div className="w-full sm:w-1/2 flex items-center justify-center py-10 sm:py-0">
        <div className="text-[#000] flex flex-col w-[90%] ml-[5%]">
          ...
          <p className="prata-regular text-2xl sm:text-sm flex justify-center mb-5 ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora eaque qui, doloremque sint nemo sequireiciendis assumenda minima? Quam, corrupti?</p>
          <div className="flex items-center gap-2">
            <Link href="/about">
