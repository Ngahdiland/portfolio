  ...
  return (
    <div className="flex flex-col sm:flex-row mt-[40px]">
      <div className="w-full sm:w-1/2 flex items-center justify-center py-10 sm:py-0">
        <div className="text-[#000] flex flex-col w-[80%] ml-[10%]">
          ...
          <h1 className="hOne prata-regular text-[70px] sm:py-3 leading-relaxed font-bold">
          ...
          <div className="flex items-center gap-2 ">
            <Link href="/about">
              <p className="toEdit font-semibold w-[300px] h-[40px] bg-amber-500 text-[30px] flex flex-col justify-center items-center rounded-xl underline italic">
                MORE ABOUT ME
              </p>
            </Link>
